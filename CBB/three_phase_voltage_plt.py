...
class ThreePhaseVoltagePLT(tpv.ThreePhaseVoltage):
    def __init__(self, mi):
        super().__init__(mi=mi)

        ##### override with PLT-specific display / time settings
        ...
        ##### recalculate Va/Vb/Vc with PLT-specific time base and start angle
    ...
    def three_voltage_plot(self, picsize=(7, 4.3)):
        ...
        for label in ax.get_xticklabels() + ax.get_yticklabels():
            label.set_fontsize(self.Gridlabels_fontsize)
...
if __name__ == "__main__":
    ...
    class_three_phase_voltage = ThreePhaseVoltagePLT(mod_idx)
