...
class PdPodCmv(tp3d.ThreePhase3D):
    def __init__(self):
        ...
        ### cmv proportion vary with modulation
    ...
    def cmv_proportion_modu(self):
        for i in range(len(self.modulation_3d)):
            ...
            for j in range(len(self.wt)):
                ...
                vmid_up_data   += self.vz_max_3d[i,j] - self.vzs_division[i,j]
                vmid_down_data += self.vzs_division[i,j] - self.vz_min_3d[i,j]
    ...
    def cmv_modu_plot(self,pic_size=(8,4.9)):
